...
class Transport(ABC):
    ...
    def from_string(cls,data):
        brand, speed, year, price = data.split(",")
        return cls(brand,float(speed),year,float(price))
    @staticmethod
    def is_fast(value):
        return value > 200
    def __str__(self):
...
class Car(Transport, Engine):
    def __init__(self,brand,speed,year,price,engine_type,horsepower):
     super().__init__(brand,speed,year,price)
     self.engine_type = engine_type
     self.horsepower = horsepower
    def move(self):
...
class Ship(Transport, Engine):
    def __init__(self,brand,speed,year,price,engine_type,able_distance):
        super().__init__(brand, speed, year, price)
        self.engine_type = engine_type
...
car1 = Car("Toyota", 150, 2020, 15000, "petrol", 120)
car2 = Car("BMW", 250, 2022, 30000, "petrol", 200)
print(car1)
print(car1 == car2)
print(car1 < car2)
print(car1 + car2
